...
| Legacy parameter distribution            | In xosc generation by `openscenario_utility`, changed the file name from encoding the parameter name and its value to simply using a sequential number. | `openscenario_utility`     | [#972](https://github.com/tier4/scenario_simulator_v2/pull/972) | [yamacir-kit](https://github.com/yamacir-kit) |
