...
| Add noise to detection sensor output           | Add noise to detection sensor output, noise is standard distribution, standard deviation can be set via API::attachDetectionSensor                                | `traffic_simulator`,`simple_sensor_simulator`                | [#915](https://github.com/tier4/scenario_simulator_v2/pull/915) | [hakuturu583](https://github.com/hakuturu583),[kyoichi-sugahara](https://github.com/kyoichi-sugahara) |     |
