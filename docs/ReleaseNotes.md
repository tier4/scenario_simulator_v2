...
| Add do noting behavior plugin                            | Add do nothing behavior plugin for driving the simulator from Autoware rosbag data.                                    | `do_nothing_plugin`,`traffic_simulator`         | [#1001](https://github.com/tier4/scenario_simulator_v2/pull/1011) | [hakuturu583](https://github.com/hakuturu583) |
