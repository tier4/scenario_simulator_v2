...
![Typical example of longitudinal distance measurement including a lane change](../image/shortest_typical_routing.png)
...
![Matching a position to a lanelet](../image/lanelet_matching.png)
