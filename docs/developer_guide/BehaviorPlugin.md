...
| EntityStatus         | Entity status of the NPC you want to control          | `std::shared_ptr<traffic_simulator_msgs::msg::CanonicalizedEntityStatus>` |
...
| UpdatedStatus        | Updated entity status of the NPC you want to control. | `std::shared_ptr<traffic_simulator_msgs::msg::CanonicalizedEntityStatus>` |
