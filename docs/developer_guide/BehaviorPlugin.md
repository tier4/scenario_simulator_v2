...
#define DEFINE_GETTER_SETTER(NAME, TYPE)                                                    \
  ...
  DEFINE_GETTER_SETTER(ReferenceTrajectory, std::shared_ptr<math::geometryCatmullRomSpline>)
...
| ReferenceTrajectory  | Trajectory precalculated for RouteLanelets.           | `std::shared_ptr<math::geometryCatmullRomSpline>` |
