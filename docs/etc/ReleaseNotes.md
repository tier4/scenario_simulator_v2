...
| Add `API::getDistanceToLaneBound()` function       | Add `API::getDistanceToLaneBound()` function for getting distance from entity polygon to lane boundary.     | `traffic_simulator`        | [#807](https://github.com/tier4/scenario_simulator_v2/pull/807) | [hakuturu583](https://github.com/hakuturu583) |
