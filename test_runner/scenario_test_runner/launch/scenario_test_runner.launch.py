...
def launch_setup(context, *args, **kwargs):
    ...
    record_config_file                          = LaunchConfiguration("record_config_file",                          default="")
    ...
    print(f"record_config_file                          := {record_config_file.perform(context)}")
    ...
    def make_parameters():
        parameters = [
            ...
            {"record": record},
            {"record_config_file": record_config_file},
    ...
    return [
        ...
        DeclareLaunchArgument("record_config_file",                          default_value=record_config_file                         ),
