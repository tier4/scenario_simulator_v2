...
`autoware_diffusion_planner` に lockstep サービスモードを追加するパッチを適用する。

```bash
cd <autoware_universe_repo>
git am <scenario_simulator_repo>/patches/autoware_diffusion_planner/0001-lockstep-service-mode.patch
```
