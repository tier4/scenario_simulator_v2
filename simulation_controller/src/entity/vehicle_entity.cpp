  ...
  parameters(xml)
{
  ...
  tree_ptr_->setValueToBlackBoard("vehicle_parameters",
    std::make_shared<simulation_controller::entity::VehicleParameters>(parameters));
}
...
void VehicleEntity::requestAcquirePosition(int lanelet_id, double s, double offset)
{
  ...
  auto target_status = simulation_controller::entity::EntityStatus(0, lanelet_id, s, offset, rpy,
      twist, accel);
...
const
{
  ...
  text_velocity.pose.position.z = parameters.bounding_box.center.z +
    parameters.bounding_box.dimensions.height * 0.5;
  ...
  text_action.pose.position.z = parameters.bounding_box.center.z +
    parameters.bounding_box.dimensions.height * 0.5 - 0.5;
  ...
  if (verbose_) {
    ...
    text_position.pose.position.z = parameters.bounding_box.center.z -
      parameters.bounding_box.dimensions.height * 0.5;
