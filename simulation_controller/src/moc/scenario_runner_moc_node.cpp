...
private:
    ...
    simulation_controller::entity::EntityStatus getEgoInitialStatus()
    {
        ...
        rpy.y = 0.0;
        rpy.z = 0.0;
        simulation_controller::entity::EntityStatus ret(api_.simulation->getCurrentTime(), 178, 0.0, 0.0, rpy, twist, accel);
        return ret;
    }
    ...
    simulation_controller::entity::EntityStatus getNpcInitialStatus()
    {
        ...
        rpy.y = 0.0;
        rpy.z = 0.0;
        simulation_controller::entity::EntityStatus ret(api_.simulation->getCurrentTime(), 178, 20.0, 0.0, rpy, twist, accel);
        return ret;
    };
    ...
    simulation_controller::entity::EntityStatus getBobInitialStatus()
    {
        ...
        rpy.y = 0.0;
        rpy.z = 0.0;
        simulation_controller::entity::EntityStatus ret(api_.simulation->getCurrentTime(), 879, 0.0, 0.0, rpy, twist, accel);
        return ret;
    }
