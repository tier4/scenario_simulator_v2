...
namespace scenario_simulator
{
    ...
    class SimulationAPIImpl : ApiImplBase<NodeT>
    {
    using ApiImplBase<NodeT>::entity_manager_ptr_;
    using ApiImplBase<NodeT>::client_ptr_;
    public:
        SimulationAPIImpl(std::shared_ptr<XmlRpc::XmlRpcClient> client_ptr, std::shared_ptr<simulation_controller::entity::EntityManager<NodeT>> entity_manager_ptr)
