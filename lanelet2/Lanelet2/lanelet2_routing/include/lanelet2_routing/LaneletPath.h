...
public:
  ...
  explicit LaneletPath(ConstLanelets lanelets = {})
...
public:
  ...
  explicit LaneletOrAreaPath(ConstLaneletOrAreas lltsOrArea = {})
  : laneletsOrAreas_{std::move(lltsOrArea)} {}
  ...
  {
    return laneletsOrAreas_ == other.laneletsOrAreas_;
  }
