...
using GraphType = boost::adjacency_list<boost::vecS, boost::vecS, boost::bidirectionalS, VertexInfo,
    EdgeInfo>;
...
public:
  ...
  explicit Graph(size_t numRoutingCosts)
  : numRoutingCosts_{numRoutingCosts} {}
  ...
  Optional<EdgeInfo> getEdgeInfoFor(
