...
public:
  ...
  static RoutingGraphUPtr build(
    const LaneletSubmap & laneletSubmap, const traffic_rules::TrafficRules & trafficRules,
    const RoutingCostPtrs & routingCosts = defaultRoutingCosts(),
    const Configuration & config = Configuration());
  ...
  Optional<LaneletPath> shortestPath(
    const ConstLanelet & from, const ConstLanelet & to, RoutingCostId routingCostId = {},
    bool withLaneChanges = true) const;
   ...
   *  @param routingCostId ID of RoutingCost module to determine shortest path
   *  @param withLaneChanges if false, the shortest path will not contain lane changes */
  Optional<LaneletOrAreaPath> shortestPathIncludingAreas(
   ...
   *  @param withLaneChanges if false, the shortest path will not contain lane changes
   *  @see shortestPath */
  Optional<LaneletPath> shortestPathVia(
    const ConstLanelet & start, const ConstLanelets & via, const ConstLanelet & end,
    RoutingCostId routingCostId = {}, bool withLaneChanges = true) const;
   ...
   *  @param withLaneChanges if false, the shortest path will not contain lane changes
   *  @see shortestPath */
  Optional<LaneletOrAreaPath> shortestPathIncludingAreasVia(
   ...
   * is not passable. */
  Optional<RelationType> routingRelation(
   ...
   *  @see following */
  LaneletRelations followingRelations(
    const ConstLanelet & lanelet,
    bool withLaneChanges = false) const;
   ...
   *  @see previous */
  LaneletRelations previousRelations(
    const ConstLanelet & lanelet,
    bool withLaneChanges = false) const;
  ...
  ConstLaneletOrAreas reachableSetIncludingAreas(
  ...
  ConstLanelets reachableSetTowards(
   ...
   *  @param allowLaneChanges Allow or forbid lane changes */
  LaneletPaths possiblePaths(
    const ConstLanelet & startPoint, double minRoutingCost, RoutingCostId routingCostId = {},
   ...
   */
  LaneletPaths possiblePaths(
    const ConstLanelet & startPoint, uint32_t minLanelets, bool allowLaneChanges = false,
    RoutingCostId routingCostId = {}) const;
   ...
   *  @param routingCostId ID of the routing cost module used
   *  @param allowLaneChanges Allow or forbid lane changes */
  LaneletPaths possiblePathsTowards(
  ...
  LaneletOrAreaPaths possiblePathsIncludingAreas(
    const ConstLaneletOrArea & startPoint, double minRoutingCost,
    RoutingCostId routingCostId = {}, bool allowLaneChanges = false) const;
  ...
  void forEachSuccessor(
    const ConstLanelet & lanelet, const LaneletVisitFunction & f, bool allowLaneChanges = true,
    RoutingCostId routingCostId = {}) const;

  //! Similar to RoutingGraph::forEachSuccessor but also includes areas into the search
  void forEachSuccessorIncludingAreas(
    const ConstLaneletOrArea & lanelet, const LaneletOrAreaVisitFunction & f,
   ...
   *  @param routingCostId ID of the routing cost module
      @see exportGraphViz */
  void exportGraphML(
    const std::string & filename, const RelationType & edgeTypesToExclude = RelationType::None,
    RoutingCostId routingCostId = {}) const;
  ...
  LaneletMapPtr getDebugLaneletMap(
    RoutingCostId routingCostId = {}, bool includeAdjacent = false,
    bool includeConflicting = false) const;
   ...
   */
  [[deprecated(
      "Use passableSubmap to obtain the lanelets and areas within the routing graph!")]]
   ...
   */
  RoutingGraph(
    std::unique_ptr<internal::RoutingGraphGraph> && graph,
