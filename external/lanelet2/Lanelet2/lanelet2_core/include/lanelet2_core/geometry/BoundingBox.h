 ...
 */
inline BoundingBox2d boundingBox2d(const ConstPoint2d & p)
{
  return {p.basicPoint2d(), p.basicPoint2d()};
}
inline BoundingBox2d boundingBox2d(const ConstPoint3d & p)
{
  return {p.basicPoint2d(), p.basicPoint2d()};
}
inline BoundingBox2d boundingBox2d(const BasicPoint2d & p) {return {p, p};}
inline BoundingBox2d boundingBox2d(const BasicPoint3d & p)
{
  return {traits::to2D(p), traits::to2D(p)};
}
 ...
 * @return the bounding box
 */
inline BoundingBox3d boundingBox3d(const ConstPoint3d & p)
{
  return BoundingBox3d(p.basicPoint(), p.basicPoint());
}
...
inline BoundingBox3d boundingBox3d(const BasicPoint2d & p)
{
  return {traits::to3D(p), traits::to3D(p)};
}
}  // namespace geometry
}  // namespace lanelet
