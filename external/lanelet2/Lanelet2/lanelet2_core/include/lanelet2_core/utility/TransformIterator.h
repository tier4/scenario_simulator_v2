...
class TransformIterator
  : public boost::iterator_adaptor<TransformIterator<Iterator, RetType, Converter>, Iterator,
    RetType>
{
  using Base = boost::iterator_adaptor<TransformIterator<Iterator, RetType, Converter>, Iterator,
      RetType>;
