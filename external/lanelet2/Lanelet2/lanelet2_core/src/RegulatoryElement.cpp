...
RegulatoryElementPtr RegulatoryElementFactory::create(
  std::string ruleName,
...
ConstRuleParameterMap RegulatoryElement::getParameters() const
{
  ...
  for (const auto & param : parameters()) {
    params.insert(std::make_pair(
        param.first, utils::transform(param.second, [](const auto & elem) {
