...
void part1BasicRegulatoryElements()
{
  ...
  RegulatoryElementPtr trafficLightRegelem = lanelet::TrafficLight::make(
    utils::getId(), {}, {trafficLight});
...
private:
  ...
  explicit LightsOn(const lanelet::RegulatoryElementDataPtr & data)
