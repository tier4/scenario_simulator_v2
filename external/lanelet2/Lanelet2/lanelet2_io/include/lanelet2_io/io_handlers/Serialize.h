...
template<typename Archive>
void serialize(
  Archive & ar, std::pair<std::string, lanelet::Attribute> & p,
...
template<typename Archive>
void serialize(
  Archive & ar, std::pair<std::string, lanelet::RuleParameters> & p,
  unsigned int /*version*/)
{
  ar & p.first;
  ar & p.second;
...
inline void save_construct_data(
  Archive & ar, const lanelet::LaneletData * llt,
  unsigned int /*version*/)
{
  ...
  if (hasCenterline) {
    ...
    lanelet::LineString3d center(std::const_pointer_cast<lanelet::LineStringData>(centerline.
      constData()),
      centerline.inverted());
    ar << center;
  }
...
inline void load_construct_data(
  Archive & ar, lanelet::LaneletData * llt, unsigned int                             /*version*/
)
{
...
// NOLINTNEXTLINE
inline void save_construct_data(
  Archive & ar, const lanelet::LineStringData * l,
  unsigned int /*version*/)
{
...
// NOLINTNEXTLINE
inline void save_construct_data(
  Archive & ar, const lanelet::PointData * p,
  unsigned int /*version*/)
{
...
// NOLINTNEXTLINE
inline void save_construct_data(
  Archive & ar, const lanelet::RegulatoryElementData * r,
  unsigned int /*version*/)
{
...
// NOLINTNEXTLINE
inline void load_construct_data(
  Archive & ar, lanelet::RegulatoryElementData * r,
  unsigned int /*version*/)
{
  using namespace lanelet;
  Id id = 0;
