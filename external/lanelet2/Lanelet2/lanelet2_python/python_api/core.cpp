...
{
  static PyObject * convert(Attribute const & s)
  {
...
struct AttributeFromPythonStr
{
  AttributeFromPythonStr()
  {
    boost::python::converter::registry::push_back(&convertible, &construct,
      boost::python::type_id<Attribute>());
  }
...
struct DictToAttributeMapConverter
{
  ...
  {
    converter::registry::push_back(&convertible, &construct, type_id<AttributeMap>());
  }
...
auto wrapLayer(const char * layerName)
{
  ...
  auto search =
    static_cast<typename LayerT::PrimitiveVec (LayerT::*)(const BoundingBox2d &)>(&LayerT::search);
  auto nearest =
    static_cast<typename LayerT::PrimitiveVec (LayerT::*)(const BasicPoint2d &,
      unsigned)>(&LayerT::nearest);
...
BOOST_PYTHON_MODULE(PYTHON_API_MODULE_NAME) {  // NOLINT
  class_<BasicPoint2d>("BasicPoint2d", "A simple point",
    init<double, double>((arg("x") = 0., arg("y") = 0.)))
  ...
  class_<BoundingBox2d>("BoundingBox2d",
    init<BasicPoint2d, BasicPoint2d>("BoundingBox2d(minPoint, maxPoint"))
  ...
  class_<BoundingBox3d>("BoundingBox3d",
    init<BasicPoint3d, BasicPoint3d>("BoundingBox3d(minPoint, maxPoint"))
  ...
  class_<RuleParameterMap>("RuleParameterMap",
    init<>("RuleParameterMap()")).def(IsHybridMap<RuleParameterMap>());
  ...
  class_<Point2d, bases<ConstPoint2d>>(
    ...
    init<Id, BasicPoint3d,
    AttributeMap>((arg("id"), arg("point"), arg("attributes") = AttributeMap())))
  .def(init<>("Point2d()"))
  ...
  .def(init<Id, Points3d,
    AttributeMap>((arg("id"), arg("points"), arg("attributes") = AttributeMap())))
  ...
  class_<ConstHybridLineString2d>("ConstHybridLineString2d",
    "A Linestring that behaves like a normal BasicLineString",
  ...
  class_<ConstHybridLineString3d>("ConstHybridLineString3d",
    "A Linestring that behaves like a normal BasicLineString",
  ...
  class_<CompoundLineString3d>("CompoundLineString3d",
    "A LineString composed of multiple linestrings",
  ...
  auto regelems =
    static_cast<const RegulatoryElementPtrs & (Lanelet::*)()>(&Lanelet::regulatoryElements);
  ...
  .add_property("centerline", &Lanelet::centerline, &Lanelet::setCenterline,
    "Centerline of the lanelet")
  ...
  .add_property("regulatoryElements", make_function(regelems,
  ...
  class_<LaneletSequence>("LaneletSequence", "A combined lane formed from multiple lanelets",
    init<ConstLanelets>())
  ...
  .def("invert", &LaneletSequence::invert,
  ...
  auto innerBounds =
    static_cast<const std::vector<LineStrings3d> & (Area::*)()>(&Area::innerBounds);
  ...
  class_<RegulatoryElement, boost::noncopyable, RegulatoryElementPtr>(
    "RegulatoryElement", "A Regulatory element defines traffic rules that affect a lanelet",
    no_init)
  ...
  .def("find", &RegulatoryElement::find<ConstRuleParameter>,
  ...
  .add_property("stopLine",
    +[] (TrafficLight & self) {return self.stopLine();}, &TrafficLight::setStopLine)
  ...
  .def("__init__", make_constructor(&RightOfWay::make, default_call_policies(),
    ...
    arg("stopLine") = Optional<LineString3d>{})))
  .add_property("stopLine",
    +[] (RightOfWay & self) {return self.stopLine();}, &RightOfWay::setStopLine)
  ...
  class_<TrafficSignsWithType, std::shared_ptr<TrafficSignsWithType>>("TrafficSignsWithType",
    no_init)
  ...
  .def("findUsages", +[] (LaneletLayer & self, RegulatoryElementPtr & e) {return self.findUsages(
        e);})
  ...
  wrapLayer<LineStringLayer>("LineStringLayer").def("findUsages",
    +[] (LineStringLayer & self, Point3d & p) {
    return self.findUsages(p);
  });
  wrapLayer<PointLayer>("PointLayer");
  wrapLayer<RegulatoryElementLayer>("RegulatoryElementLayer");

  class_<LaneletMapLayers, boost::noncopyable>("LaneletMapLayers",
  ...
  def("createSubmapFromLineStrings", createSubmapWrapper<LineStrings3d>,
    "Create submap from primitives");
