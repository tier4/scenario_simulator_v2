...
namespace scenario_runner { inline namespace syntax
{
  ...
  std::basic_istream<Ts...>& operator >>(std::basic_istream<Ts...>& is, StoryboardElementState& state)
  {
    std::string buffer {};
  ...
  template <typename... Ts>
  std::basic_ostream<Ts...>& operator <<(std::basic_ostream<Ts...>& os, const StoryboardElementState& state)
  {
    switch (state)
    {
      #define BOILERPLATE(IDENTIFIER) case StoryboardElementState::IDENTIFIER: return os << #IDENTIFIER;
    ...
    default:
      std::stringstream ss {};
      ss << "enum class StoryboardElementState holds unexpected value " << static_cast<StoryboardElementState::value_type>(state.value);
  ...
  static const auto start_transition { make<StoryboardElementState>(StoryboardElementState::startTransition) };
  static const auto   end_transition { make<StoryboardElementState>(StoryboardElementState::endTransition) };
  static const auto  stop_transition { make<StoryboardElementState>(StoryboardElementState::stopTransition) };
  static const auto  skip_transition { make<StoryboardElementState>(StoryboardElementState::skipTransition) };
