...
namespace scenario_simulator
{
    ...
    bool ScenarioSimulator::checkRequiredFields(std::vector<std::string> required_fields, XmlRpc::XmlRpcValue& param, XmlRpc::XmlRpcValue& result)
    {
    ...
    void ScenarioSimulator::addMethod(std::string name,std::function<void(XmlRpc::XmlRpcValue&, XmlRpc::XmlRpcValue&)> func)
    {
    ...
    std::vector<std::string> ScenarioSimulator::getNonExistingRequredFields(std::vector<std::string> required_fields, XmlRpc::XmlRpcValue& param)
    {
