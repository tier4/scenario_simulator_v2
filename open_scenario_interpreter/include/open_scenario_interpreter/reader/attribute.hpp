...
#ifndef OPEN_SCENARIO_INTERPRETER__READER__ATTRIBUTE_HPP_
#define OPEN_SCENARIO_INTERPRETER__READER__ATTRIBUTE_HPP_

#include <ament_index_cpp/get_package_share_directory.hpp>
#include <open_scenario_interpreter/syntax/parameter_type.hpp>
#include <open_scenario_interpreter/utility/highlighter.hpp>
#include <open_scenario_interpreter/utility/pugi_extension.hpp>
...
T readAttribute(const std::string & name, const Node & node, const Scope & scope)
{
  if (const auto & attribute {node.attribute(name.c_str())}) {
    ...
    if (value.empty()) {
      #ifndef OPEN_SCENARIO_INTERPRETER_ALLOW_ATTRIBUTES_TO_BE_BLANK
      std::stringstream ss {};
...
#endif  // OPEN_SCENARIO_INTERPRETER__READER__ATTRIBUTE_HPP_
