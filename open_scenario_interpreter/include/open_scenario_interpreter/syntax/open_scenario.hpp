...
#include <open_scenario_interpreter/syntax/road_network.hpp>
#include <open_scenario_interpreter/syntax/storyboard.hpp>
...
#endif  // OPEN_SCENARIO_INTERPRETER__SYNTAX__OPEN_SCENARIO_HPP_
