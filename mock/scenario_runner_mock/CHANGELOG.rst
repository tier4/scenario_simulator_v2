^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package scenario_runner_mock
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* Merge branch 'master' of https://github.com/tier4/scenario_simulator.auto into feature/simulation_controller
* Merge branch 'master' into refactor/scenario_runner/storyboard_element
* Merge pull request `#21 <https://github.com/tier4/scenario_simulator_v2/issues/21>`_ from tier4/feature/launcher_life_cycle
  Feature/launcher life cycle mock
* use wall timer instead
* set license
* add lifecycle test
* Contributors: Masaya Kataoka, TaikiTanaka3, Tatsuya Yamasaki, Yamasaki Tatsuya, taikitanaka, taikitanaka3, yamacir-kit
