...
{
class TrafficSimulationDemoScenario : public context_gamma_scenarios::ContextGammaScenarioNode
{
public:
...
int main(int argc, char * argv[])
{
  ...
  auto component =
    std::make_shared<context_gamma_scenarios::TrafficSimulationDemoScenario>(options);
