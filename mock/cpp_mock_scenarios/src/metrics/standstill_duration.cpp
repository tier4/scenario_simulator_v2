...
class StandstillDuration : public cpp_mock_scenarios::CppScenarioNode
{
public:
  explicit StandstillDuration(const rclcpp::NodeOptions & option)
...
int main(int argc, char * argv[])
{
  ...
  auto component = std::make_shared<StandstillDuration>(options);
