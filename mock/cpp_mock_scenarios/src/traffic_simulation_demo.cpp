...
private:
  ...
  void onInitialize() override
  {
    ...
    api_.spawn(
      false, "tom", getPedestrianParameters(), "ego",
    ...
    api_.spawn(
      false, "npc3", getVehicleParameters(),
      traffic_simulator::helper::constructLaneletPose(34468, 0),
      traffic_simulator::helper::constructActionStatus(10));
    api_.spawn(
      false, "obstacle", getMiscObjectParameters(), "ego",
      traffic_simulator::helper::constructPose(10, 5, 0, 0, 0, -1.57),
      traffic_simulator::helper::constructActionStatus());
