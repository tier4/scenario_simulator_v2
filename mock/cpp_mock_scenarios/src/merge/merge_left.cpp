...
private:
  ...
  {
    api_.spawn(
      "ego", canonicalize(traffic_simulator::helper::constructLaneletPose(34462, 15, 0, 0, 0, 0)),
    ...
    api_.spawn(
      "npc", canonicalize(traffic_simulator::helper::constructLaneletPose(34513, 0, 0, 0, 0, 0)),
      getVehicleParameters());
