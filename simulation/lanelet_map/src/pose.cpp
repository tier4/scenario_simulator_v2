  ...
  -> geometry_msgs::msg::PoseStamped
{
  if (
    ...
    throw std::runtime_error(
      "Lanelet pose (id=" + std::to_string(lanelet_pose.lanelet_id) +
      ",s=" + std::to_string(lanelet_pose.s) + ",offset=" + std::to_string(lanelet_pose.offset) +
      ",rpy.x=" + std::to_string(lanelet_pose.rpy.x) + ",rpy.y=" +
      std::to_string(lanelet_pose.rpy.y) + ",rpy.z=" + std::to_string(lanelet_pose.rpy.z) +
  ...
  const auto canonicalize_to_previous_lanelet =
    ...
    if (const auto ids = other::getPreviousLaneletIds(lanelet_pose.lanelet_id); !ids.empty()) {
      ...
      for (const auto id : ids) {
        const auto lanelet_pose_tmp = pose::constructLaneletPose(
