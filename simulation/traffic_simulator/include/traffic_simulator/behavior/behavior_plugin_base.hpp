...
#define DEFINE_GETTER_SETTER(NAME, KEY, TYPE)      \
  ...
  DEFINE_GETTER_SETTER(FollowClothoidTrajectoryParameter, "clothoid_trajectory_parameter", std::shared_ptr<traffic_simulator::follow_trajectory::Parameter<traffic_simulator::follow_trajectory::Clothoid>>)
  DEFINE_GETTER_SETTER(FollowNurbsTrajectoryParameter, "nurbs_trajectory_parameter", std::shared_ptr<traffic_simulator::follow_trajectory::Parameter<traffic_simulator::follow_trajectory::Nurbs>>)
