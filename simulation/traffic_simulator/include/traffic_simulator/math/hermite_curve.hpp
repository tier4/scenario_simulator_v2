...
public:
  ...
  boost::optional<double> getSValue(
    geometry_msgs::msg::Point position, double threshold_distance = 0.03,
    unsigned int initial_resolution = 50, unsigned int max_iteration = 30, double tolerance = 0.001,
