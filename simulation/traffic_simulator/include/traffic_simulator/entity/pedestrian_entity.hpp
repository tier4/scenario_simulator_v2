...
public:
  ...
  void requestAcquirePosition(
    const CanonicalizedLaneletPose & lanelet_pose, const RouteOptions &) override;

  void requestAcquirePosition(
    const geometry_msgs::msg::Pose & map_pose, const RouteOptions &) override;
  ...
  void requestAssignRoute(
    const std::vector<CanonicalizedLaneletPose> & waypoints, const RouteOptions &) override;
