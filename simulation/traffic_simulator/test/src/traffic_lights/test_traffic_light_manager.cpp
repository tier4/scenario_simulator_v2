...
#include <traffic_simulator/traffic_lights/traffic_light_manager______.hpp>
...
TEST(TrafficLightManager, getIds)
{
  ...
  traffic_simulator::ConventionalTrafficLightManager<autoware_auto_perception_msgs::msg::TrafficSignalArray>
