...
TEST(TrafficLight, Color)
{
...

  {
    ...
    EXPECT_TRUE(color == Color::amber);
    EXPECT_TRUE(color.is(Color::amber));
    EXPECT_TRUE(boost::lexical_cast<Color>("amber") == Color::amber);
    EXPECT_TRUE(boost::lexical_cast<std::string>(color) == "amber");
  }
...

  {
    ...
    EXPECT_TRUE(color == Color::amber);
    EXPECT_TRUE(color.is(Color::amber));
    EXPECT_TRUE(boost::lexical_cast<Color>("yellow") == Color::amber);
    EXPECT_TRUE(boost::lexical_cast<std::string>(color) == "amber");
  }
}
