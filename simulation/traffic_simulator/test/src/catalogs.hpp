...
auto getVehicleParameters() -> traffic_simulator_msgs::msg::VehicleParameters
{
  ...
  parameters.subtype.subtype = traffic_simulator_msgs::msg::EntitySubtype::CAR;
...
auto getPedestrianParameters() -> traffic_simulator_msgs::msg::PedestrianParameters
{
  ...
  parameters.subtype.subtype = traffic_simulator_msgs::msg::EntitySubtype::PEDESTRIAN;
...
auto getMiscObjectParameters() -> traffic_simulator_msgs::msg::MiscObjectParameters
{
  ...
  misc_object_param.subtype.subtype = traffic_simulator_msgs::msg::EntitySubtype::UNKNOWN;
