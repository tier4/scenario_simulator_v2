  ...
  const geometry_msgs::msg::Pose & pose1, const openscenario_msgs::msg::BoundingBox & bbox1)
{
  ...
  if (boost::geometryintersects(poly0, poly1)) {
    return boost::none;
  }
  if (boost::geometryintersects(poly1, poly0)) {
    return boost::none;
  }
  if (boost::geometrydisjoint(poly0, poly1)) {
    return boost::geometrydistance(poly0, poly1);
  }
  return boost::none;
}
  ...
  const geometry_msgs::msg::Pose & pose, const openscenario_msgs::msg::BoundingBox & bbox)
{
  ...
  typedef boost::geometrymodel::d2::point_xy<double> bg_point;
  boost::geometrymodel::polygon<bg_point> poly;
