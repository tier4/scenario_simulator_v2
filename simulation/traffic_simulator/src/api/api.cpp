...
bool API::attachDetectionSensor(
  const std::string & entity_name, double detection_sensor_range, bool filter_by_range,
  ...
  double object_recognition_delay)
{
  return attachDetectionSensor(helper::constructDetectionSensorConfiguration(
    ...
    detection_sensor_range, filter_by_range, pos_noise_stddev, random_seed, probability_of_lost,
