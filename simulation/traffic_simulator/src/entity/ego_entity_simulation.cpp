...
EgoEntitySimulation::EgoEntitySimulation(const traffic_simulator_msgs::msg::VehicleParameters & parameters, const Configuration &, double step_time)
...
void EgoEntitySimulation::requestSpeedChange(double value)
{
  ...
  void EgoEntitySimulation::onUpdate(double time, double step_time, bool) {
    autoware->rethrow();
