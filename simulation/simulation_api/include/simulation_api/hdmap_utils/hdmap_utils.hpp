...
public:
  ...
  const std::vector<int> getRightOfWayLaneletIds(int lanelet_id) const;
  const std::unordered_map<int,std::vector<int>> getRightOfWayLaneletIds(std::vector<int> lanelet_ids) const;
