...
#ifndef REACTIVE_AGENT_PLUGIN_PLUGIN_HPP_
#define REACTIVE_AGENT_PLUGIN_PLUGIN_HPP_

#include <traffic_simulator/behavior/behavior_plugin_base.hpp>

namespace entity_behavior
{
class ReactiveAgentBehavior : public BehaviorPluginBase
{
public:
...
#endif  // REACTIVE_AGENT_PLUGIN_PLUGIN_HPP_
