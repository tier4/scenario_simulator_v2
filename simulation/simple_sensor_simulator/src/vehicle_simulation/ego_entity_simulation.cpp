  ...
  -> const std::shared_ptr<SimModelInterface>
{
  ...
  const auto vel_time_constant          = getParameterFromExistingNode<double>(node, "vel_time_constant",           0.1);
  const auto vel_time_delay             = getParameterFromExistingNode<double>(node, "vel_time_delay",              0.1);
