...
#include <simple_sensor_simulator/vehicle_simulation/vehicle_model/sim_model_actuation_cmd.hpp>
#include <string>
#include <vector>

// NOTE: this file is copied from https://github.com/autowarefoundation/autoware_universe/blob/0.50.2/simulator/autoware_simple_planning_simulator/src/simple_planning_simulator/vehicle_model/sim_model_actuation_cmd.cpp
...
double SimModelActuationCmd::getX() { return state_(IDX::X); }
double SimModelActuationCmd::getY() { return state_(IDX::Y); }
double SimModelActuationCmd::getYaw() { return state_(IDX::YAW); }
double SimModelActuationCmd::getVx() { return state_(IDX::VX); }
double SimModelActuationCmd::getVy() { return 0.0; }
double SimModelActuationCmd::getAx() { return state_(IDX::ACCX); }
double SimModelActuationCmd::getWz()
{
  return state_(IDX::VX) * std::tan(state_(IDX::STEER)) / wheelbase_;
}
double SimModelActuationCmd::getSteer() { return state_(IDX::STEER) + steer_bias_; }
