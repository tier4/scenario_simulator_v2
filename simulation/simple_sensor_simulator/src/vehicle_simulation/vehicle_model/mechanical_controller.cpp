...
#include <numeric>
#include <optional>
#include <simple_sensor_simulator/vehicle_simulation/vehicle_model/mechanical_controller.hpp>
#include <utility>
#include <vector>
...
double feedforward(const double input_angle, const double ff_gain) { return ff_gain * input_angle; }
...
PIDControllerState PIDController::get_state() const { return state_; }

void PIDController::clear_state() { state_ = {0.0, 0.0}; }
...
void SteeringDynamics::set_state(const SteeringDynamicsState & state) { state_ = state; }

SteeringDynamicsState SteeringDynamics::get_state() const { return state_; }

void SteeringDynamics::set_steer(const double steer) { state_.angular_position = steer; }

void SteeringDynamics::clear_state() { state_ = {0.0, 0.0, false}; }
...
void MechanicalController::set_steer(const double steer) { steering_dynamics_.set_steer(steer); }
