  ...
  const autoware_auto_perception_msgs::msg::DetectedObjects::SharedPtr msg)
{
  ...
  std::shared_ptr<std::normal_distribution<>> pos_noise_dist = std::make_shared<std::normal_distribution<>>(0.0, pos_noise_stddev);
  ...
  detected_objects_with_noise.header = detected_objects_ptr_->header;
  detected_objects_with_noise.objects = detected_objects_ptr_->objects;
