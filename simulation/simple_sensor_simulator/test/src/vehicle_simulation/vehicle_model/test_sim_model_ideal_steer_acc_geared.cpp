...
TEST(SimModelIdealSteerAccGeared, update_nonZeroDT)
{
  const double wheelbase = 1.0;
  auto model = SimModelIdealSteerAccGeared(wheelbase);
...
TEST(SimModelIdealSteerAccGeared, update_zeroDT)
{
  const double wheelbase = 1.0;
  auto model = SimModelIdealSteerAccGeared(wheelbase);
  SimModelInterface * p_model = &model;
...
TEST(SimModelIdealSteerAccGeared, calcModel_zeroWheelbase)
{
