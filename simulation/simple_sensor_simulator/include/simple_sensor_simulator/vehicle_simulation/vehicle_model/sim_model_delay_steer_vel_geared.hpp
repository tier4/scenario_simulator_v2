...
#ifndef SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_DELAY_STEER_VEL_GEARED_HPP_
#define SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_DELAY_STEER_VEL_GEARED_HPP_
...
/**
 * @class SimModelDelaySteerVelGeared
 * @brief calculate delay steering dynamics with gear
 */
class SimModelDelaySteerVelGeared : public SimModelInterface
{
public:
  /**
   * @brief constructor
   ...
   * @param [in] debug_vx_scaling_factor scaling factor for velocity command
   * @param [in] debug_steer_scaling_factor scaling factor for steering command
   */
  SimModelDelaySteerVelGeared(
   ...
   * @brief destructor
   */
  ~SimModelDelaySteerVelGeared() = default;
...
private:
  ...
  const double debug_vx_scaling_factor_;     //!< @brief scaling factor for velocity command
...
#endif  // SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_DELAY_STEER_VEL_GEARED_HPP_ 