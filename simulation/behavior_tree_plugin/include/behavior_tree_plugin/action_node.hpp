...
public:
  ...
  auto foundConflictingEntity(const std::vector<lanelet::Id> & following_lanelets) const -> bool;
  ...
  auto getRightOfWayEntities(const std::vector<lanelet::Id> & following_lanelets) const
    -> std::vector<traffic_simulator::CanonicalizedEntityStatus>;
  auto getYieldStopDistance(const std::vector<lanelet::Id> & following_lanelets) const
    -> std::optional<double>;
...
private:
  ...
  auto getConflictingEntityStatus(const std::vector<lanelet::Id> & following_lanelets) const
    -> std::optional<traffic_simulator::CanonicalizedEntityStatus>;
  auto getConflictingEntityStatusOnCrossWalk(const std::vector<lanelet::Id> & route_lanelets) const
    -> std::vector<traffic_simulator::CanonicalizedEntityStatus>;
  auto getConflictingEntityStatusOnLane(const std::vector<lanelet::Id> & route_lanelets) const
    -> std::vector<traffic_simulator::CanonicalizedEntityStatus>;
};
}  // namespace entity_behavior
