...
#define DEFINE_GETTER_SETTER(NAME, TYPE)                                                    \
  ...
  DEFINE_GETTER_SETTER(FollowClothoidTrajectoryParameter, traffic_simulator::follow_trajectory::Parameter<traffic_simulator::follow_trajectory::Clothoid>)
  DEFINE_GETTER_SETTER(FollowNurbsTrajectoryParameter, traffic_simulator::follow_trajectory::Parameter<traffic_simulator::follow_trajectory::Nurbs>)
  DEFINE_GETTER_SETTER(FollowPolylineTrajectoryParameter, traffic_simulator::follow_trajectory::Parameter<traffic_simulator::follow_trajectory::Polyline>)
