  ...
  geometry_msgs::msg::Pose pose1, traffic_simulator_msgs::msg::BoundingBox bbox1)
{
  ...
  const bg::model::polygon<bg_point> poly0 = geometry_math::get2DPolygon(pose0, bbox0);
  const bg::model::polygon<bg_point> poly1 = geometry_math::get2DPolygon(pose1, bbox1);
