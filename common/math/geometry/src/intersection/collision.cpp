  ...
  geometry_msgs::msg::Pose pose1, traffic_simulator_msgs::msg::BoundingBox bbox1)
{
  ...
  const bg::model::polygon<bg_point> poly0 = math::geometryget2DPolygon(pose0, bbox0);
  const bg::model::polygon<bg_point> poly1 = math::geometryget2DPolygon(pose1, bbox1);
