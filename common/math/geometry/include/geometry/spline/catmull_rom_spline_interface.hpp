...
public:
  ...
  /**
   * @brief Calculates nearest s value estimation from given range and its squared distance in 2D.
   ...
   * (either <= 0 or >= 0).
   */
  auto estimateNearestS(const geometry_msgs::msg::Point & point, double s_start, double s_end) const
