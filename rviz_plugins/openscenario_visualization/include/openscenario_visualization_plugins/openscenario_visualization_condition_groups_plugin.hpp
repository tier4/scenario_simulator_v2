...
#ifndef OPENSCENARIO_VISUALIZATION_CONDITION_GROUPS_HPP_
#define OPENSCENARIO_VISUALIZATION_CONDITION_GROUPS_HPP_
...
class VisualizationConditionGroupsDisplay : public rviz_common::Display
{
  Q_OBJECT

public:
  VisualizationConditionGroupsDisplay();
  virtual ~VisualizationConditionGroupsDisplay();
...
#endif  // OPENSCENARIO_VISUALIZATION_CONDITION_GROUPS_HPP_
