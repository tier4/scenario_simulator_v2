...
def test(scenario_name, desired_diff_num):
    ...
    os.system("xmllint --format " + input_xosc + " > " + str(output_dir) + "/before.xosc")
...
def test_by_entity_condition_entity_condition_distance_condition_shortest():
    test("ByEntityCondition.EntityCondition.DistanceCondition.Shortest", 0)
...
def test_by_entity_condition_entity_condition_distance_condition_freespace():
    test("ByEntityCondition.EntityCondition.DistanceConditionFreespace", 0)
...
def test_autoware_simple():
    test("autoware-simple", 132)

def test_collision():
    test("collision", 0)

def test_collision_condition_by_type():
    test("collision_condition_by_type", 376)
...
def test_failure_single_condition_anonymous():
    test("failure_single_condition_anonymous", 67)

def test_failure_single_condition_named():
    test("failure_single_condition_named", 67)
...
def test_failure_three_conditions_two_groups_trigger_anonymous():
    test("failure_three_conditions_two_groups_trigger_anonymous", 79)

def test_failure_three_conditions_two_groups_trigger_named():
    test("failure_three_conditions_two_groups_trigger_named", 79)

def test_failure_two_conditions_different_group_trigger_anonymous():
    test("failure_two_conditions_different_group_trigger_anonymous", 74)

def test_failure_two_conditions_different_group_trigger_named():
    test("failure_two_conditions_different_group_trigger_named", 74)

def test_failure_two_conditions_single_group_named():
    test("failure_two_conditions_single_group_named", 72)

def test_failure_two_conditions_single_group_one_named():
    test("failure_two_conditions_single_group_one_named", 72)
...
def test_prefixed_name_reference():
    test("prefixed-name-reference", 173)

def test_relative_target_speed():
    test("relative_target_speed", 208)

def test_sample():
    test("sample", 132)

def test_sample_awsim():
    test("sample_awsim", 192)

def test_sample_awsim_conventional_traffic_lights():
    test("sample_awsim_conventional_traffic_lights", 201)

def test_sample_awsim_v2i_traffic_lights():
    test("sample_awsim_v2i_traffic_lights", 184)

def test_set_behavior_parameters_in_object_controller():
    test("set_behavior_parameters_in_object_controller", 145)

def test_spawn_relative_object_position():
    test("spawn_relative_object_position", 313)

def test_spawn_relative_world():
    test("spawn_relative_world", 178)
